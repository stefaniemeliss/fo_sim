...
# load data
df <- read.csv(file.path(cd, "All_data_FO.csv"))
...
for (i in 1:length(vars)) {
  ...
  if (vars[i] == "FO" | vars[i] == "FO self-efficacy") {
    ...
    plt <- ggplot(data = dfl_sum, aes(x = variable, y = value, group = 1)) +
      ...
      coord_cartesian(ylim = c(ymin, ymax))  + scale_y_continuous(n.breaks = 3)
    ggsave(plot = plt,
           filename = file.path(dir_figs, paste0("Figure5_H4_", vars_out[i], "_sum.jpg")), 
    ...
    plt <- ggplot(data = dfl_wtd, aes(x = variable, y = value, group = 1)) +
      ...
      coord_cartesian(ylim = c(ymin, ymax))  + scale_y_continuous(n.breaks = 3)
    ggsave(plot = plt,
           filename = file.path(dir_figs, paste0("Figure5_H4_", vars_out[i], "_wtd.jpg")), 
           units = "px", width = px_w, height = px_h, dpi = 300)
  ...
  plt <- ggplot(data = dfl_sum, aes(x = variable, y = value, group = 1)) +
    ...
    coord_cartesian(ylim = c(ymin, ymax))  + scale_y_continuous(n.breaks = breaks)
  ggsave(plot = plt,
         filename = file.path(dir_figs, paste0("FigureB2_H4_", vars_out[i], "_sum.jpg")), 
         units = "px", width = px_w, height = px_h, dpi = 300)
  ...
  plt <- ggplot(data = dfl_wtd, aes(x = variable, y = value, group = 1)) +
    ...
    coord_cartesian(ylim = c(ymin, ymax))  + scale_y_continuous(n.breaks = breaks)
  ggsave(plot = plt,
         filename = file.path(dir_figs, paste0("FigureB2_H4_", vars_out[i], "_wtd.jpg")), 
         units = "px", width = px_w, height = px_h, dpi = 300)
...
ggsave(plot = main,
       filename = file.path(dir_figs, "Figure5_H4.jpg"), 
