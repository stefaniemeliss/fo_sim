...
ggsave(plot = binned_skill, 
       filename = file.path(dir_figs, "FigureB1_skill.jpg"), 
...
ggsave(plot = binned_tot, 
       filename = file.path(dir_figs, "FigureB1_tot.jpg"), 
       units = "px", width = 2160, height = 764, dpi = 300)
...
plt <- ggplot(data = beta[beta$DV == "Participant skill", ], aes(x = `FO subscale`, y = beta)) +
  ...
  ambition_theme_minimal
ggsave(plot = plt, 
       filename = file.path(dir_figs, "Figure3_H1B_skill.jpg"), 
       units = "px", width = 2160, height = 764, dpi = 300)
...
plt <- ggplot(data = beta[beta$DV == "Time off task", ], aes(x = `FO subscale`, y = beta)) +
  ...
  ambition_theme_minimal
ggsave(plot = plt, 
       filename = file.path(dir_figs, "Figure3_H1B_tot.jpg"), 
       units = "px", width = 2160, height = 764, dpi = 300)
