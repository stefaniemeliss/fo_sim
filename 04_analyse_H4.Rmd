...
for (i in 1:length(vars)) {
  ...
  if (vars[i] == "FO" | vars[i] == "FO self-efficacy") {
    ...
    plt <- ggplot(data = dfl_sum, aes(x = variable, y = value, group = 1)) +
      ...
      coord_cartesian(ylim = c(ymin, ymax))  + scale_y_continuous(n.breaks = breaks)
    ggsave(plot = plt,
           filename = file.path(dir_figs, paste0("Figure5_H4_", vars_out[i], "_sum_minimal.jpg")), 
    ...
    plt <- ggplot(data = dfl_wtd, aes(x = variable, y = value, group = 1)) +
      ...
      coord_cartesian(ylim = c(ymin, ymax))  + scale_y_continuous(n.breaks = breaks)
    ggsave(plot = plt,
           filename = file.path(dir_figs, paste0("Figure5_H4_", vars_out[i], "_wtd_minimal.jpg")), 
           units = "px", width = px_w, height = px_h, dpi = 300)
    ...
    # save orig
    ggsave(plot = sum4eds,
           filename = file.path(dir_figs, paste0("Figure_Sum4Eds_", vars_out[i], ".jpg")), 
           units = "cm", width = 16, height = 6)
    
    # export for Ambition pub - wtd
    sum4eds <- sum4eds + ambition_theme_minimal
    ggsave(plot = sum4eds,
           filename = file.path(dir_figs, paste0("Figure_Sum4Eds_", vars_out[i], "_minimal.jpg")), 
           units = "px", width = px_w, height = px_h, dpi = 300)
  }
  ...
  plt <- ggplot(data = dfl_sum, aes(x = variable, y = value, group = 1)) +
    ...
    coord_cartesian(ylim = c(ymin, ymax))  + scale_y_continuous(n.breaks = breaks)
  ggsave(plot = plt,
         filename = file.path(dir_figs, paste0("FigureB2_H4_", vars_out[i], "_sum_minimal.jpg.jpg")), 
         units = "px", width = px_w, height = px_h, dpi = 300)
  ...
  plt <- ggplot(data = dfl_wtd, aes(x = variable, y = value, group = 1)) +
    ...
    coord_cartesian(ylim = c(ymin, ymax))  + scale_y_continuous(n.breaks = breaks)
  ggsave(plot = plt,
         filename = file.path(dir_figs, paste0("FigureB2_H4_", vars_out[i], "_wtd_minimal.jpg.jpg")), 
         units = "px", width = px_w, height = px_h, dpi = 300)
...
![image](figures/Figure5_H4.jpg)
![image](figures/FigureB2_H4.jpg)
