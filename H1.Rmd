...
ggplot(tmp, aes(x = acc_change, y = fo)) + 
  geom_point(col = navy) +
  ambition_theme + 
  xlab("Change in participant skill between Sim 1 and 2")+ylab("Feedback orientation")
...
ggplot(tmp, aes(x = tot_change, y = fo)) + 
  geom_point(col = navy) +
  ambition_theme + 
  xlab("Change in time off task between Sim 1 and 2")+ylab("Feedback orientation")
