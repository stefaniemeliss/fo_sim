---
title: "FO Simulator - FEEDBACK ORIENTATION STUDY: preliminary data checks and outlier identification"
author: "Stefanie Meliss"
date: "`r Sys.Date()`"
output: html_document
---

## Final exclusions sim study  (as of September 4th 2023)
...
# remove ppt
file  <- "C:/Users/stefanie.meliss/OneDrive - Ambition Institute/research_projects/Ark Feedback Orientation and Sims/Analysis/Final_exclusions_Ark_ITTs_4Sept.xlsx"
...
Based on the simulator study data, a possible cut-off for accuracy of 0.3 was identified. Applying this cut-off to the FO data identifies the following participants:   

```{r, echo = F, results='asis'}
# remove ppt that did not respond at all or responded in all trials or have a hitrate of 0
desc <- df[df$rate_accuracy < 0.3, c("pseudonym", rates_nback)]
desc <- na.omit(desc)

kbl(desc, caption = "participants with accuracy below 0.3", row.names = F) %>%
            kable_styling(bootstrap_options = c("striped", "hover", "condensed"))
