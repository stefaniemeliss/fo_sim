...
ggsave(plot = plt, 
       filename = file.path(dir_figs, "Figure4_H2B_autumn.jpg"), 
...
plt <- ggplot(data = beta[beta$DV == "Spring term", ], aes(x = `FO subscale`, y = beta)) +
  ...
  ambition_theme_minimal
ggsave(plot = plt, 
       filename = file.path(dir_figs, "Figure4_H2B_spring.jpg"), 
       units = "px", width = 2160, height = 764, dpi = 300)
