...
names(out) <- c("variable", "Survey 1", "Survey 2", "Improvement", "Paired t-test")
...
##### Paired sample t-test with above median time interval between surveys only
...
#### Predicting improvement with time interval
...
# save file
write.csv(out,
          file = file.path(cd, "H2_exp_v1.csv"),
          row.names = F)
...
##### Predicting Survey 2 measures with Survey 1 measures, time interval and interaction  
